...
export default function BottomNav(){
  ...
  return (
   <nav className={styles.container}>
      ...
      <a href="{()=>false}" className={styles.focusedTxt}>홈</a>
      </div>
      </NavLink>
      ...
      <a href="{()=>false}" className={styles.focusedTxt}>게시판</a>
      </div>
      </NavLink>
      ...
      <a href="{()=>false}" className={styles.focusedTxt}>명장면</a>
      </div>
      </NavLink>
      ...
      <a href="{()=>false}" className={styles.focusedTxt}>뽑기</a>
      </div>
      </NavLink>
